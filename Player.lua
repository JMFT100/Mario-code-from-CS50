...
function Player:init(map)
    ...
    self.behaviors = {
        ...
        ['walking'] = function(dt)
            ...
            -- checks for collisions moving from left to right
...
function Player:update(dt)
    ...
    --[[
    if we have any negative y velocity (jumping), check if we collide 
...
--checks two tiles to our left to see if a collision occured
...
--checks tow tiles to our right to see if a collision occured
function Player:checkRightCollision()
    if self.dx > 0 then
        --checks if there's a tile directly beneath us
